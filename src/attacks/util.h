...
namespace stoat::attacks::internal {
    ...
    constexpr util::MultiArray<Bitboard, Colors::kCount, Squares::kCount> kEmptyBoardLanceAttacks = {
        generateEmptyBoardAttacks<offsets::kNorth>(), // black
        generateEmptyBoardAttacks<offsets::kSouth>(), // white
    };

    constexpr auto kEmptyBoardBishopAttacks =
    ...
    constexpr auto kEmptyBoardRookAttacks =
        generateEmptyBoardAttacks<offsets::kNorth, offsets::kSouth, offsets::kWest, offsets::kEast>();
} // namespace stoat::attacks::internal
